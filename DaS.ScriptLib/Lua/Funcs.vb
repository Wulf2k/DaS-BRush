...
Namespace Lua
    ...
    Public Class Funcs
        ...
        Public Shared Function MsgBoxChoice(text As String, choice1 As String, choice2 As String) As Integer
            Return SetGenDialog(text, 2, choice1, choice2).Item("Response")
        End Function
        <NLua.LuaGlobal(Description:="?Description?")> 'TODO: Description
        ...
        Public Shared Sub SetEntityLoc(entityPtr As Integer, location As Loc)
            ...
            SetEntityLoc(entityPtr, New Loc(location.Pos.X, location.Pos.Y, location.Pos.Z, location.Rot))
        ...
        Public Shared Function SetGenDialog(ByVal str As String, type As Integer, Optional btn0 As String = "", Optional btn1 As String = "") As NLua.LuaTable
            ...
            Return DirectCast(LuaInterface.E("{ " & $"Response = {genDiagResponse}, Val = {genDiagVal}" & " }")(0), NLua.LuaTable)
        End Function
        <NLua.LuaGlobal(Description:="?Description?")> 'TODO: Description
