...
Namespace Game.Data.Structures
    ...
    Public Class Entity
        ...
        Public AddressReadFunc As Func(Of Integer) = Function() 0

        Public Sub New(addrReadFunc As Func(Of Integer))
            AddressReadFunc = addrReadFunc
        End Sub

        Public Sub New(addr As Integer)
            Dim addrDeref As Integer = addr
            AddressReadFunc = Function() addrDeref
        End Sub

        Public Property HeaderPtr As Integer
            Get
                Return RInt32(Address + &HC)
            End Get
            Set(value As Integer)
                WInt32(Address + &HC, value)
            End Set
        End Property
        ...
        Public Property DisableEventBackreadState As Boolean
            Get
                Return RBool(Address + &H14)
            End Get
            Set(value As Boolean)
                WBool(Address + &H14, value)
            End Set
        End Property
        ...
        Public Property ModelName As String
            Get
                Return RUnicodeStr(Address + &H38, 10)
            End Get
            Set(value As String)
                WUnicodeStr(Address + &H38, value.Substring(0, Math.Min(value.Length, 10)))
            End Set
        End Property

        Public Property NPCID As Int32
            Get
                Return RInt32(Address + &H68)
            End Get
            Set(value As Int32)
                WInt32(Address + &H68, value)
            End Set
        End Property

        Public Property NPCID2 As Int32
            Get
                Return RInt32(Address + &H6C)
            End Get
            Set(value As Int32)
                WInt32(Address + &H6C, value)
            End Set
        End Property

        Public Property ChrType As Int32
            Get
                Return RInt32(Address + &H70)
            End Get
            Set(value As Int32)
                WInt32(Address + &H70, value)
            End Set
        End Property

        Public Property TeamType As Int32
            Get
                Return RInt32(Address + &H74)
            End Get
            Set(value As Int32)
                WInt32(Address + &H74, value)
            End Set
        End Property

        Public Property IsTargetLocked As Boolean
            Get
                Return RBool(Address + &H128)
            End Get
            Set(value As Boolean)
                WBool(Address + &H128, value)
            End Set
        End Property

        Public ReadOnly Property DeathStructPointer As Int32
            Get
                Return RInt32(Address + &H170)
            End Get
        End Property
        ...
        Public Property PoiseCurrent As Single
            Get
                Return RFloat(Address + &H1C0)
            End Get
            Set(value As Single)
                WFloat(Address + &H1C0, value)
            End Set
        End Property

        Public Property PoiseMax As Single
            Get
                Return RFloat(Address + &H1C4)
            End Get
            Set(value As Single)
                WFloat(Address + &H1C4, value)
            End Set
        End Property

        Public Property PoiseRecoverTimer As Single
            Get
                Return RFloat(Address + &H1CC)
            End Get
            Set(value As Single)
                WFloat(Address + &H1CC, value)
            End Set
        End Property

        Public Property FlagsA As EntityFlagsA
            Get
                Return CType(RInt32(Address + &H1FC), EntityFlagsA)
            End Get
            Set(value As EntityFlagsA)
                WInt32(Address + &H1FC, CType(value, Integer))
            End Set
        End Property

        Public Property FlagsB As EntityFlagsB
            Get
                Return CType(RInt32(Address + &H200), EntityFlagsB)
            End Get
            Set(value As EntityFlagsB)
                WInt32(Address + &H200, CType(value, Integer))
            End Set
        End Property
        ...
        Public Property Opacity As Single
            Get
                Return RFloat(Address + &H258)
            End Get
            Set(value As Single)
                WFloat(Address + &H258, value)
            End Set
        End Property

        Public Property DrawGroup1 As Int32
            Get
                Return RInt32(Address + &H264)
            End Get
            Set(value As Int32)
                WInt32(Address + &H264, value)
            End Set
        End Property

        Public Property DrawGroup2 As Int32
            Get
                Return RInt32(Address + &H268)
            End Get
            Set(value As Int32)
                WInt32(Address + &H268, value)
            End Set
        End Property

        Public Property DrawGroup3 As Int32
            Get
                Return RInt32(Address + &H26C)
            End Get
            Set(value As Int32)
                WInt32(Address + &H26C, value)
            End Set
        End Property

        Public Property DrawGroup4 As Int32
            Get
                Return RInt32(Address + &H270)
            End Get
            Set(value As Int32)
                WInt32(Address + &H270, value)
            End Set
        End Property

        Public Property DispGroup1 As Int32
            Get
                Return RInt32(Address + &H274)
            End Get
            Set(value As Int32)
                WInt32(Address + &H274, value)
            End Set
        End Property

        Public Property DispGroup2 As Int32
            Get
                Return RInt32(Address + &H278)
            End Get
            Set(value As Int32)
                WInt32(Address + &H278, value)
            End Set
        End Property

        Public Property DispGroup3 As Int32
            Get
                Return RInt32(Address + &H27C)
            End Get
            Set(value As Int32)
                WInt32(Address + &H27C, value)
            End Set
        End Property

        Public Property DispGroup4 As Int32
            Get
                Return RInt32(Address + &H280)
            End Get
            Set(value As Int32)
                WInt32(Address + &H280, value)
            End Set
        End Property

        Public Property MultiplayerZone As Int32
            Get
                Return RInt32(Address + &H284)
            End Get
            Set(value As Int32)
                WInt32(Address + &H284, value)
            End Set
        End Property

        Public Property Material_Floor As Short
            Get
                Return RInt16(Address + &H288)
            End Get
            Set(value As Short)
                WInt16(Address + &H288, value)
            End Set
        End Property

        Public Property Material_ArmorSE As Short
            Get
                Return RInt16(Address + &H28A)
            End Get
            Set(value As Short)
                WInt16(Address + &H28A, value)
            End Set
        End Property

        Public Property Material_ArmorSFX As Short
            Get
                Return RInt16(Address + &H28C)
            End Get
            Set(value As Short)
                WInt16(Address + &H28C, value)
            End Set
        End Property

        Public Property HP As Int32
            Get
                Return RInt32(Address + &H2D4)
            End Get
            Set(value As Int32)
                WInt32(Address + &H2D4, value)
            End Set
        End Property

        Public Property MaxHP As Int32
            Get
                Return RInt32(Address + &H2D8)
            End Get
            Set(value As Int32)
                WInt32(Address + &H2D8, value)
            End Set
        End Property

        Public Property Stamina As Int32
            Get
                Return RInt32(Address + &H2E4)
            End Get
            Set(value As Int32)
                WInt32(Address + &H2E4, value)
            End Set
        End Property

        Public Property MaxStamina As Int32
            Get
                Return RInt32(Address + &H2E8)
            End Get
            Set(value As Int32)
                WInt32(Address + &H2E8, value)
            End Set
        End Property

        Public Property ResistancePoisonCurrent As Int32
            Get
                Return RInt32(Address + &H300)
            End Get
            Set(value As Int32)
                WInt32(Address + &H300, value)
            End Set
        End Property

        Public Property ResistanceToxicCurrent As Int32
            Get
                Return RInt32(Address + &H304)
            End Get
            Set(value As Int32)
                WInt32(Address + &H304, value)
            End Set
        End Property

        Public Property ResistanceBleedCurrent As Int32
            Get
                Return RInt32(Address + &H308)
            End Get
            Set(value As Int32)
                WInt32(Address + &H308, value)
            End Set
        End Property

        Public Property ResistanceCurseCurrent As Int32
            Get
                Return RInt32(Address + &H30C)
            End Get
            Set(value As Int32)
                WInt32(Address + &H30C, value)
            End Set
        End Property

        Public Property ResistancePoisonMax As Int32
            Get
                Return RInt32(Address + &H310)
            End Get
            Set(value As Int32)
                WInt32(Address + &H310, value)
            End Set
        End Property

        Public Property ResistanceToxicMax As Int32
            Get
                Return RInt32(Address + &H314)
            End Get
            Set(value As Int32)
                WInt32(Address + &H314, value)
            End Set
        End Property

        Public Property ResistanceBleedMax As Int32
            Get
                Return RInt32(Address + &H318)
            End Get
            Set(value As Int32)
                WInt32(Address + &H318, value)
            End Set
        End Property

        Public Property ResistanceCurseMax As Int32
            Get
                Return RInt32(Address + &H31C)
            End Get
            Set(value As Int32)
                WInt32(Address + &H31C, value)
            End Set
        End Property

        Public Property Unknown1Ptr As Int32
            Get
                Return RInt32(Address + &H330)
            End Get
            Set(value As Integer)
                WInt32(Address + &H330, value)
            End Set
        End Property


        Public Property CharMapDataPtr As Integer
            Get
                Return RInt32(Address + &H28)
            End Get
            Set(value As Integer)
                WInt32(Address + &H28, value)
            End Set
        End Property
        ...
        Public Property AnimationPtr As Integer
            Get
                Return RInt32(CharMapDataPtr + &H14)
            End Get
            Set(value As Integer)
                WInt32(CharMapDataPtr + &H14, value)
            End Set
        End Property

        Public Property AnimationInstancePtr As Integer
            Get
                Return RInt32(RInt32(RInt32(AnimationPtr + &HC) + &H10))
            End Get
            Set(value As Integer)
                WInt32(RInt32(RInt32(AnimationPtr + &HC) + &H10), value)
            End Set
        End Property
...
#Region "STATS"
        ...
        Public Property StatsPtr As Integer
            Get
                Return RInt32(Address + &H414)
            End Get
            Set(value As Integer)
                WInt32(Address + &H414, value)
            End Set
        End Property
        ...
        Public Property StatName As String
            Get
                Return RUnicodeStr(Address + &HA0, MAX_STATNAME_LENGTH)
            End Get
            Set(value As String)
                WAsciiStr(Address + &HA0, value.Substring(0, Math.Min(value.Length, MAX_STATNAME_LENGTH)))
            End Set
        End Property
...
#Region "Static"
        ...
        Public Shared ReadOnly Property PlayerStablePosAddress As Integer = &H13784A0

        Public Shared Property PlayerStablePosX As Single
            Get
                Return RFloat(PlayerStablePosAddress + &HB70)
            End Get
            Set(value As Single)
                WFloat(PlayerStablePosAddress + &HB70, value)
            End Set
        End Property

        Public Shared Property PlayerStablePosY As Single
            Get
                Return RFloat(PlayerStablePosAddress + &HB74)
            End Get
            Set(value As Single)
                WFloat(PlayerStablePosAddress + &HB74, value)
            End Set
        End Property

        Public Shared Property PlayerStablePosZ As Single
            Get
                Return RFloat(PlayerStablePosAddress + &HB78)
            End Get
            Set(value As Single)
                WFloat(PlayerStablePosAddress + &HB78, value)
            End Set
        End Property
#End Region
        ...
        Public Property DebugFlags As EntityDebugFlags
            Get
                Return CType(RInt32(Address + &H3C4), EntityDebugFlags)
            End Get
            Set(value As EntityDebugFlags)
                WInt32(Address + &H3C4, CType(value, Integer))
            End Set
        End Property
