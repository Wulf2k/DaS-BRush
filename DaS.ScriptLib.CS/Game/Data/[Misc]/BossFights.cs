...
namespace DaS.ScriptLib.Game.Data
{
	...
	public partial class Misc
	{
		...
		public static ReadOnlyDictionary<EventFlag.Boss, BossFightInfo> BossFights { get; }

		public static BossFightInfo GetBossFight(int bossFlag)
		{
			return BossFights[(EventFlag.Boss)bossFlag];
		}
		...
		private static void InitBossFights()
		{
			...
			BossFightInfo[] __bossFights = {
				new BossFightInfo(DaS.ScriptLib.Game.Data.EventFlag.Boss.AsylumDemon, "Asylum Demon") {
			...
			dynamic d = new Dictionary<EventFlag.Boss, BossFightInfo>();
			foreach (BossFightInfo boss_loopVariable in __bossFights) {
				boss = boss_loopVariable;
				d.Add(boss.SpawnFlag, boss);
			}
			_BossFights = new ReadOnlyDictionary<EventFlag.Boss, BossFightInfo>(d);
