...
Namespace LuaScripting
    ...
    Public Class Funcs
        ...
        Public Shared Function GetAllCurrentlyLoadedMsbData(getNewTable As [Delegate]) As LuaTable
            Dim tmpPtr As Integer = 0
            ...
            Dim result = DirectCast(getNewTable.DynamicInvoke()(0), LuaTable)
            For mapNum = 0 To mapCount - 1
                entitiesPtr = RInt32(mapPtrs + 4 * mapNum)
            ...
            entitiesPtr = RInt32(entitiesPtr + &H40)
                ...
                result(tableIndexMapName) = DirectCast(getNewTable.DynamicInvoke()(0), LuaTable)
        ...
        Public Shared Sub WarpEntity_Player(entityptr As Integer)
            Dim playerptr As Integer = DSLua.Expr("GetEntityPtr(10000)")
        ...
        Public Shared Function GetEntityPtr(entityId As Integer) As Integer
            ...
            Return DSLua.CallIngameFuncREG(FuncReturnType.INT, &HD6C360, reg, entityId)
        End Function
    End Class
