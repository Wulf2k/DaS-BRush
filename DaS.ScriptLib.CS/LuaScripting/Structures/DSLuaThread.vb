...
Namespace LuaScripting.Structures
    ...
    Public Class DSLuaThread

        Private ReadOnly [Function] As [Delegate]
        ...
        Public Sub New(luaFunc As [Delegate])
            [Function] = luaFunc
        ...
        Private Function _callFunctionAndReturnValue(params As Object) As Object()
            ...
            ElseIf TypeOf params Is LuaTable Then
                Return [Function].DynamicInvoke(DirectCast(params, LuaTable).Values.Cast(Of Object).ToArray())
            Else
                Return [Function].DynamicInvoke(params)
            End If
        End Function
